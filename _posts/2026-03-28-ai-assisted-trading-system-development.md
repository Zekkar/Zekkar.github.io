...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 200" style="width:100%;height:auto;" font-family="'Noto Sans TC','Segoe UI',sans-serif">
  ...
  <rect width="800" height="200" rx="12" fill="#f8f9fc"/>
  <text x="400" y="28" text-anchor="middle" font-size="18" font-weight="bold" fill="#1a1a2e">大型功能設計流程</text>
  ...
  <g filter="url(#s2)"><rect x="10" y="125" width="780" height="55" rx="10" fill="white" stroke="#e0e6ed"/>
    <text x="35" y="150" font-size="12" fill="#1a1a2e"><tspan font-weight="bold">每個 Task：</tspan> Implementer Agent 實作 → Spec 合規審查 → Code Quality 審查 → Commit</text>
    <text x="35" y="170" font-size="11" fill="#888">獨立 context，互不干擾，兩階段 review 確保品質</text>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 380" style="width:100%;height:auto;" font-family="'Noto Sans TC','Segoe UI',sans-serif">
  ...
  <rect width="800" height="380" rx="12" fill="#f8f9fc"/>
  <text x="400" y="28" text-anchor="middle" font-size="18" font-weight="bold" fill="#1a1a2e">Telegram 驅動的開發互動</text>
  <!-- Participants -->
  ...
  <text x="400" y="345" text-anchor="middle" font-size="12" fill="#667eea">任何裝置、任何地點 → 不需開 IDE → 設計決策在 Telegram 確認</text>
</svg>
